...
if ($fila = pg_fetch_row($consulta2)){
	...
	//echo 'inserta';
	$cadena ="INSERT INTO COMISIONES (IDCARRERA,ANIO,COMISION,FOPERACION,USUARIO,ANIO_LECTIVO,CUPO) VALUES";
	$cadena.="($idcarrera,$anio,'$comision',now(),'{$_SESSION['usuario']}',$anio_lectivo,$cupo);";
}

$inscribir = dbConsultar($base,$cadena);
if($inscribir) echo 'Comision actualizada con éxito';
echo '<iframe style="display:none;" onload="trae_comision(\'Comisión agregada con éxito\')"></iframe>';
?>