...
if($verif[1]==$idalumno){
	...
	<br>
	Por medio de la presente queda constancia de que el alumno <b>'.$datos[0].', '.$datos[1].'</b> se inscribio en el establecimiento Esc. Normal Superior Lenguas Vivas Juan Bautista Alberdi (nivel Superior), en la carrera <b>'.$datos_carrera[2].'</b> el día <b>'.$fecha.'</b>. Los detalles de la inscripción se describen a continuación.
	<br><br>
	<style>
	*{
		font-size: 12px;
	...
	<table class="detalle" border=1 width=100% style="border:1px;" cellspacing=2>
		...
		<tr>
			<td><b>Telefono:<b> </td><td>'.$datos[11].'</td><td><b></b></td><td></td><td></td><td></td>
		</tr>
	</table>

	<table class="detalle" border=1 width=100% style="border:1px;" cellspacing=2>
		<tr><th colspan=8 style="background-color:rgb(200,200,200);">Domicilio</th></tr>
		<tr>
			<td><b>Domicilio:<b> </td><td>'.$datos[3].'</td><td><b>Nro:</b></td><td>'.$datos[4].'</td><td><b>Piso:</b></td><td>'.$datos[5].'</td><td><b>Depto.:</b></td><td>'.$datos[6].'</td>
		</tr>
		<tr>
			<td><b>País:<b> </td><td>'.$nacionalidad.'</td><td><b>Provincia:</b></td><td>'.$prov[1].'</td><td><b>Departamento:</b></td><td>'.$depto[0].'</td><td><b>Localidad:</b></td><td>'.$local[0].'</td>
		</tr>
	</table>
	<table class="detalle" border=1 width=100% style="border:1px;" cellspacing=2>
		<tr><th colspan=4 style="background-color:rgb(200,200,200);">Carrera</th></tr>
		<tr>
			<td><b>Carrera:<b> </td><td>'.$datos_carrera[2].'</td><td><b>Año:<b> </td><td>1ero</td>
		</tr>
	</table>
	<br>
